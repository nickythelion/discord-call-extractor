...
class TestGenericCall(ut.TestCase):
    ...
    def test_instancing(self):
        call = GenericCall("TestCaller", "TestFriend", "29-Oct-2021 1:43 PM", "Started a call that lasted 69 minutes.")
    ...
    def test_to_csv(self):
        ...
        self.assertEqual(call.to_csv(), "\"TestCaller\",\"TestFriend\",\"29/10/2021\",\"13:43\",\"69 minutes\"")